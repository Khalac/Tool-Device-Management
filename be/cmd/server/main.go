...
func main() {
	...
	departmetHandler := handler.NewDepartmentsHandler(departmentService)
	...
	r := gin.Default()
	api.SetupRoutes(r, userHandler, locationHandler, categoriesHandler, departmetHandler, userSessionRepository)
